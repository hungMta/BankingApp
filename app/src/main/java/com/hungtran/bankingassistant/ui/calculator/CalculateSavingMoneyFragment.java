...
public class CalculateSavingMoneyFragment extends BaseFragment implements CalculatorContract.View, View.OnClickListener {
    ...
    public int getLayoutId() {
        return R.layout.fragment_caluclate_interest_money;
    }
    ...
    private void setRecyclerViewCalculateMoney() {
        ...
        mCalculateInterestMoneyRecylerViewAdapter = new CalculateInterestMoneyRecylerViewAdapter(Constant.TYPE_SAVING,null);
    ...
    @Override
    public void onCalculateLoanResult(long interestPaymentPerMonth, long principalPaymentPerMonth, long totalPaymentPerMonth, long totalInterestPayment, long totalPayment, List<CalculateInterestMoneyModel> loanList) {
